...
collisionManager.addCoupling(g1)
...
collisionManager.addParticle( constructPybindParticle(topQuarkL, temperatureHack) )
collisionManager.addParticle( constructPybindParticle(topQuarkR, temperatureHack) )
