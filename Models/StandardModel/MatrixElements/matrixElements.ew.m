...
(*light quarks*)
RepLightQ = CreateParticle[{3,6,7,8,11,12,13},"F"];
...
the remainin particle content is set as light
*)
ParticleList={ReptL,ReptR,RepLightQ,RepLepL,RepGluon,RepW,RepH};
...
(*
	output of matrix elements
*)
OutputFile="matrixElements.ewNew";
SetDirectory[NotebookDirectory[]];
ParticleName={"TopL","TopR","LightQuark","LepL","Gluon","W","H"};
MatrixElements=ExportMatrixElements[
	OutputFile,
	ParticleList,
	UserMasses,
